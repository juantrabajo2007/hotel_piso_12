...
const SITE_TITLE = "Hotel Piso 12 — Alojamiento boutique en Bello, Antioquia";
const SITE_DESC =
  "Hotel boutique en Bello, Antioquia. Habitaciones cómodas, atención personalizada y excelente ubicación cerca de Medellín. Reserva directa al mejor precio.";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Hotel Piso 12" },
      { name: "theme-color", content: "#0F172A" },
      { property: "og:title", content: SITE_TITLE },
      { property: "og:description", content: SITE_DESC },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Hotel Piso 12" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress: "Diagonal 55 #37-41",
